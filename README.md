npm[![banner](https://raw.githubusercontent.com/oceanprotocol/art/master/github/repo-banner%402x.png)](https://oceanprotocol.com)

<h1 align="center">Direct Trade Platform</h1>
...
- The name "Direct Trade Market" is also copyright protected and should be changed to the name of your market.
...
If you are looking to fork Direct Trade Market and create your own marketplace, you will find the following guides useful in our docs:

- [Forking Direct Trade Market](https://docs.oceanprotocol.com/building-with-ocean/build-a-marketplace/forking-ocean-market)
...
Direct Trade Market comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
